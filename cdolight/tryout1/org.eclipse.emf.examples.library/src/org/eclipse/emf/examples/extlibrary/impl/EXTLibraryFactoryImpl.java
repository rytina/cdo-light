...
public class EXTLibraryFactoryImpl extends EFactoryImpl implements EXTLibraryFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EXTLibraryPackage.BOOK: return (EObject)createBook();
			case EXTLibraryPackage.LIBRARY: return (EObject)createLibrary();
			case EXTLibraryPackage.WRITER: return (EObject)createWriter();
			case EXTLibraryPackage.BOOK_ON_TAPE: return (EObject)createBookOnTape();
			case EXTLibraryPackage.VIDEO_CASSETTE: return (EObject)createVideoCassette();
			case EXTLibraryPackage.BORROWER: return (EObject)createBorrower();
			case EXTLibraryPackage.PERSON: return (EObject)createPerson();
			case EXTLibraryPackage.EMPLOYEE: return (EObject)createEmployee();
			default:
